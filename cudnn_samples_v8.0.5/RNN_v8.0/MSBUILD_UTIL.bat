...
@set PATH=%MS_ROOT%\windsdk\7.1\bin;%MS_ROOT%\msvc120u2\VC\bin\amd64;%MS_ROOT%\windsdk\7.1\bin\NETFX 4.0 Tools\x64;%MS_ROOT%\windsdk\7.1\bin\x64;%PATH%
@set INCLUDE=%MS_ROOT%\msvc120u2\VC\include\;%MS_ROOT%\windsdk\7.1\include\;%INCLUDE%
@set LIB=%MS_ROOT%\msvc120u2\VC\bin\amd64\;%MS_ROOT%\windsdk\7.1\Lib\x64\;%MS_ROOT%\msvc120u2\VC\lib\amd64\;%LIB%
